...
Usage:
  node {baseDir}/scripts/submit-almighty-video.js --json '{"model":"WERYDANCE_2_0","prompt":"Use image and video refs","images":["https://example.com/1.png"],"videos":["https://example.com/1.mp4"],"duration":5}'
